!function(c) {
    ...
    c.fn.showclock = function() {
        var n = new Date
          ...
          , s = [0, 0];
        if (null != c(this).data("time") && (s = c(this).data("time").split(":")),
        (a = new Date(o[0],o[1] - 1,o[2],s[0],s[1]).getTime() / 1e3 - n.getTime() / 1e3) <= 0 || isNaN(a))
            return this.hide(),
            this;
        ...
        var s = Math.floor(a / 60)
          , a = Math.floor(a % 60)
          , n = "";
        0 != t && (n += "<div class='countdown-container days'>",
