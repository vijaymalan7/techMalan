                    ...
                    for (var t = p.call(arguments, 1), i = 0, o = this.length; i < o; i++) {
                        ...
                        if (n)
                            if (a.isFunction(n[e]) && "_" !== e.charAt(0)) {
                                ...
                                u("no such method '" + e + "' for " + r + " instance");
                        else
                            u("cannot call methods on " + r + " prior to initialization; attempted to call '" + e + "'")
                    }
                    return this
                }
            }
...
function() {
    ...
    i.addListener = function(t, e) {
        ...
        for (i in o)
            o.hasOwnProperty(i) && -1 === r(o[i], e) && o[i].push(n ? e : {
                listener: e,
                once: !1
            });
        return this
    ...
    i.manipulateListeners = function(t, e, i) {
        ...
        if ("object" != typeof e || e instanceof RegExp)
            ...
            for (o in e)
                e.hasOwnProperty(o) && (n = e[o]) && ("function" == typeof n ? r : s).call(this, o, n);
        return this
    }
    ,
...
function(L) {
    ...
    function t(g) {
        ...
        return function(t) {
            ...
            ,
            (_ = g("boxSizing")) && ((c = document.createElement("div")).style.width = "200px",
...
function(e) {
    ...
    function t(t) {
        return "complete" === r.readyState ? n() : (t.bind(r, "DOMContentLoaded", o),
    ...
    f.filterFindElements = function(t, e) {
        for (var i = [], o = 0, n = (t = f.makeArray(t)).length; o < n; o++) {
            ...
            if (f.isElement(r))
                if (e) {
                    p(r, e) && i.push(r);
                    for (var s = r.querySelectorAll(e), a = 0, u = s.length; a < u; a++)
                        i.push(s[a])
                } else
                    i.push(r)
        }
...
function(n, r) {
    "function" == typeof define && define.amd ? define("outlayer/item", ["eventEmitter/EventEmitter", "get-size/get-size", "get-style-property/get-style-property", "fizzy-ui-utils/utils"], function(t, e, i, o) {
        return r(n, t, e, i, o)
    }) : "object" == typeof exports ? module.exports = r(n, require("wolfy87-eventemitter"), require("get-size"), require("desandro-get-style-property"), require("fizzy-ui-utils")) : (n.Outlayer = {},
    n.Outlayer.Item = r(n, n.EventEmitter, n.getSize, n.getStyleProperty, n.fizzyUIUtils))
    ...
    n.prototype.layoutPosition = function() {
        ...
        n = e.percentPosition && e.isHorizontal ? n / t.height * 100 + "%" : n + "px";
        i[o] = n,
        i[r] = "",
        this.css(i),
    ...
    ,
    n.prototype.transition = n.prototype[u ? "_transition" : "_nonTransition"],
...
function(r, s) {
    ...
    function s(t, e) {
        ...
        (d[e] = this)._create(),
        this.options.isInitLayout && this.layout()) : u && u.error("Bad element for " + this.constructor.namespace + ": " + (i || t))
    }
    function a() {}
    var u = t.console
      , p = t.jQuery
...
function(t, e) {
    ...
    t.prototype._getItemLayoutPosition = function(t) {
        ...
        for (var e = t.size.outerWidth % this.columnWidth, i = Math[e && e < 1 ? "round" : "ceil"](t.size.outerWidth / this.columnWidth), i = Math.min(i, this.cols), o = this._getColGroup(i), e = Math.min.apply(Math, o), n = u.indexOf(o, e), i = {
            ...
            y: e
        }, r = e + t.size.outerHeight, s = this.cols + 1 - o.length, a = 0; a < s; a++)
            this.colYs[n + a] = r;
        return i
    }
    ,
    ...
    t.prototype._manageStamp = function(t) {
        ...
        for (var n = Math.min(this.cols - 1, n), r = (this.options.isOriginTop ? i.top : i.bottom) + e.outerHeight, s = o; s <= n; s++)
...
function(s, a) {
    ...
    var d = function(t) {
        if ("string" != typeof t)
            return t;
        var e, i, o = u(t).split(" "), n = o[0], t = (t = n.match(/^\[(.+)\]$/)) && t[1], r = (i = n,
        (e = t) ? function(t) {
        ...
        this.filteredItems.sort(function(t, e) {
            for (var i = 0, o = a.length; i < o; i++) {
                var n = a[i]
                  ...
                  , s = e.sortData[n];
                if (s < r || r < s)
                    return (s < r ? 1 : -1) * ((void 0 !== u[n] ? u[n] : u) ? 1 : -1)
            }
            return 0
        }),
